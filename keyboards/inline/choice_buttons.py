...
# КИТ
spo_kit_batton = InlineKeyboardMarkup(row_width=1)

free_spo_kit1 = InlineKeyboardButton(text="🆓Бюджет🆓", callback_data="free_spo_1")
spo_kit_batton.insert(free_spo_kit1)
...
# ТК
spo_tk_batton = InlineKeyboardMarkup(row_width=1)

free_spo_tk1 = InlineKeyboardButton(text="🆓бюджет🆓", callback_data="free_tk_1")
spo_tk_batton.insert(free_spo_tk1)
# Образовательная программа
programm_spo4tk_button = InlineKeyboardMarkup(row_width=1)

programm_tk_1 = InlineKeyboardButton(text="Техническое обслуживание и ремонт двигателей, систем и агрегатов автомобилей", callback_data="technical_1")
...
programm_tk_3 = InlineKeyboardButton(text="Управление качеством продукции, процессов и услуг (по отраслям)",callback_data="quality_management_1")
...
lol_iret1205 = InlineKeyboardButton(text="Инфокоммуникационные системы и их информационная защита",
                                    callback_data="lol11_205")
...
i_3206 = InlineKeyboardButton(
    text="Управление беспилотными летательными аппаратами. Интеллектульные технические системы. Робототехника",
    callback_data="ia_3206")
...
lol_iret1206 = InlineKeyboardButton(text="Инфокоммуникационные системы и их информационная защита",
                                    callback_data="lol11_206")
...
i_3207 = InlineKeyboardButton(
    text="Управление беспилотными летательными аппаратами. Интеллектульные технические системы. Робототехника",
    callback_data="ia_3207")
...
lol_iret1207 = InlineKeyboardButton(text="Инфокоммуникационные системы и их информационная защита",
                                    callback_data="lol11_207")
...
i_3208 = InlineKeyboardButton(
    text="Управление беспилотными летательными аппаратами. Интеллектульные технические системы. Робототехника",
    callback_data="ia_3208")
...
lol_iret1208 = InlineKeyboardButton(text="Инфокоммуникационные системы и их информационная защита",
                                    callback_data="lol11_208")
...
i_3209 = InlineKeyboardButton(
    text="Управление беспилотными летательными аппаратами. Интеллектульные технические системы. Робототехника",
    callback_data="ia_3209")
...
lol_iret1209 = InlineKeyboardButton(text="Инфокоммуникационные системы и их информационная защита",
                                    callback_data="lol11_209")
...
lol_button209 = InlineKeyboardButton(
    text="Интеллектуальная радиоэлектроника и фотоника, встроенные системы, интернет вещей", callback_data="lol[2]_209")
...
i_3210 = InlineKeyboardButton(
    text="Управление беспилотными летательными аппаратами. Интеллектульные технические системы. Робототехника",
    callback_data="ia_3210")
...
lol_iret1210 = InlineKeyboardButton(text="Инфокоммуникационные системы и их информационная защита",
                                    callback_data="lol11_210")
...
lol_button210 = InlineKeyboardButton(
    text="Интеллектуальная радиоэлектроника и фотоника, встроенные системы, интернет вещей", callback_data="lol[2]_210")
...
i_3211 = InlineKeyboardButton(
    text="Управление беспилотными летательными аппаратами. Интеллектульные технические системы. Робототехника",
    callback_data="ia_3211")
...
I_6211 = InlineKeyboardButton(text="Электрооборудование предприятий, летательных аппаратов и автомобилей",
                              callback_data="ia_6211")
...
lol_iret1211 = InlineKeyboardButton(text="Инфокоммуникационные системы и их информационная защита",
                                    callback_data="lol11_211")
...
lol_button211 = InlineKeyboardButton(
    text="Интеллектуальная радиоэлектроника и фотоника, встроенные системы, интернет вещей", callback_data="lol[2]_211")
...
i_3220 = InlineKeyboardButton(
    text="Управление беспилотными летательными аппаратами. Интеллектульные технические системы. Робототехника",
    callback_data="ia_3220")
...
I_6220 = InlineKeyboardButton(text="Электрооборудование предприятий, летательных аппаратов и автомобилей",
                              callback_data="ia_6220")
...
lol_iret1220 = InlineKeyboardButton(text="Инфокоммуникационные системы и их информационная защита",
                                    callback_data="lol11_220")
...
lol_iret3220 = InlineKeyboardButton(
    text="Интеллектуальная радиоэлектроника и фотоника, встроенные системы, интернет вещей", callback_data="lol[2]_220")
...
i_3226 = InlineKeyboardButton(
    text="Управление беспилотными летательными аппаратами. Интеллектульные технические системы. Робототехника",
    callback_data="ia_3226")
...
I_6226 = InlineKeyboardButton(text="Электрооборудование предприятий, летательных аппаратов и автомобилей",
                              callback_data="ia_6226")
...
lol_iret1226 = InlineKeyboardButton(text="Инфокоммуникационные системы и их информационная защита",
                                    callback_data="lol11_226")
...
lol_iret3226 = InlineKeyboardButton(
    text="Интеллектуальная радиоэлектроника и фотоника, встроенные системы, интернет вещей", callback_data="lol[2]_226")
...
lol_iret5226 = InlineKeyboardButton(
    text="Системы передачи и обработки информации, управления, навигации и радиоэлектронной борьбы",
    callback_data="lol[4]_226")
...
i_3228 = InlineKeyboardButton(
    text="Управление беспилотными летательными аппаратами. Интеллектульные технические системы. Робототехника",
    callback_data="ia_3228")
...
I_6228 = InlineKeyboardButton(text="Электрооборудование предприятий, летательных аппаратов и автомобилей",
                              callback_data="ia_6228")
...
lol_iret1228 = InlineKeyboardButton(text="Инфокоммуникационные системы и их информационная защита",
                                    callback_data="lol11_228")
...
lol_iret3228 = InlineKeyboardButton(
    text="Интеллектуальная радиоэлектроника и фотоника, встроенные системы, интернет вещей", callback_data="lol[2]_228")
...
lol_iret5228 = InlineKeyboardButton(
    text="Системы передачи и обработки информации, управления, навигации и радиоэлектронной борьбы",
    callback_data="lol[4]_228")
...
i_3232 = InlineKeyboardButton(
    text="Управление беспилотными летательными аппаратами. Интеллектульные технические системы. Робототехника",
    callback_data="ia_3232")
...
I_6232 = InlineKeyboardButton(text="Электрооборудование предприятий, летательных аппаратов и автомобилей",
                              callback_data="ia_6232")
...
lol_iret1232 = InlineKeyboardButton(text="Инфокоммуникационные системы и их информационная защита",
                                    callback_data="lol11_232")
...
lol_iret3232 = InlineKeyboardButton(
    text="Интеллектуальная радиоэлектроника и фотоника, встроенные системы, интернет вещей", callback_data="lol[2]_232")
...
lol_iret5232 = InlineKeyboardButton(
    text="Системы передачи и обработки информации, управления, навигации и радиоэлектронной борьбы",
    callback_data="lol[4]_232")
...
Iktzi_2233 = InlineKeyboardButton(text="Программирование и администратирование компьютерных систем",
                                  callback_data="proga_1233")
...
i_3233 = InlineKeyboardButton(
    text="Управление беспилотными летательными аппаратами. Интеллектульные технические системы. Робототехника",
    callback_data="ia_3233")
...
I_6233 = InlineKeyboardButton(text="Электрооборудование предприятий, летательных аппаратов и автомобилей",
                              callback_data="ia_6233")
...
lol_iret1233 = InlineKeyboardButton(text="Инфокоммуникационные системы и их информационная защита",
                                    callback_data="lol11_233")
...
lol_iret3233 = InlineKeyboardButton(
    text="Интеллектуальная радиоэлектроника и фотоника, встроенные системы, интернет вещей", callback_data="lol[2]_233")
...
lol_iret5233 = InlineKeyboardButton(
    text="Системы передачи и обработки информации, управления, навигации и радиоэлектронной борьбы",
    callback_data="lol[4]_233")
...
Iktzi_2235 = InlineKeyboardButton(text="Программирование и администратирование компьютерных систем",
                                  callback_data="proga_1235")
...
i_3235 = InlineKeyboardButton(
    text="Управление беспилотными летательными аппаратами. Интеллектульные технические системы. Робототехника",
    callback_data="ia_3235")
...
I_6235 = InlineKeyboardButton(text="Электрооборудование предприятий, летательных аппаратов и автомобилей",
                              callback_data="ia_6235")
...
lol_iret1235 = InlineKeyboardButton(text="Инфокоммуникационные системы и их информационная защита",
                                    callback_data="lol11_235")
...
lol_iret3235 = InlineKeyboardButton(
    text="Интеллектуальная радиоэлектроника и фотоника, встроенные системы, интернет вещей", callback_data="lol[2]_235")
...
lol_iret5235 = InlineKeyboardButton(
    text="Системы передачи и обработки информации, управления, навигации и радиоэлектронной борьбы",
    callback_data="lol[4]_235")
...
Iktzi_2240 = InlineKeyboardButton(text="Программирование и администратирование компьютерных систем",
                                  callback_data="proga_1240")
...
i_3240 = InlineKeyboardButton(
    text="Управление беспилотными летательными аппаратами. Интеллектульные технические системы. Робототехника",
    callback_data="ia_3240")
...
I_6240 = InlineKeyboardButton(text="Электрооборудование предприятий, летательных аппаратов и автомобилей",
                              callback_data="ia_6240")
...
lol_iret1240 = InlineKeyboardButton(text="Инфокоммуникационные системы и их информационная защита",
                                    callback_data="lol11_240")
...
lol_iret3240 = InlineKeyboardButton(
    text="Интеллектуальная радиоэлектроника и фотоника, встроенные системы, интернет вещей", callback_data="lol[2]_240")
...
lol_iret5240 = InlineKeyboardButton(
    text="Системы передачи и обработки информации, управления, навигации и радиоэлектронной борьбы",
    callback_data="lol[4]_240")
...
Iktzi_2241 = InlineKeyboardButton(text="Программирование и администратирование компьютерных систем",
                                  callback_data="proga_1241")
...
i_3241 = InlineKeyboardButton(
    text="Управление беспилотными летательными аппаратами. Интеллектульные технические системы. Робототехника",
    callback_data="ia_3241")
...
I_6241 = InlineKeyboardButton(text="Электрооборудование предприятий, летательных аппаратов и автомобилей",
                              callback_data="ia_6241")
...
lol_iret1241 = InlineKeyboardButton(text="Инфокоммуникационные системы и их информационная защита",
                                    callback_data="lol11_241")
...
lol_iret3241 = InlineKeyboardButton(
    text="Интеллектуальная радиоэлектроника и фотоника, встроенные системы, интернет вещей", callback_data="lol[2]_241")
...
lol_iret5241 = InlineKeyboardButton(
    text="Системы передачи и обработки информации, управления, навигации и радиоэлектронной борьбы",
    callback_data="lol[4]_241")
...
Iktzi_2250 = InlineKeyboardButton(text="Программирование и администратирование компьютерных систем",
                                  callback_data="proga_1250")
...
i_3250 = InlineKeyboardButton(
    text="Управление беспилотными летательными аппаратами. Интеллектульные технические системы. Робототехника",
    callback_data="ia_3250")
...
I_6250 = InlineKeyboardButton(text="Электрооборудование предприятий, летательных аппаратов и автомобилей",
                              callback_data="ia_6250")
...
lol_iret1250 = InlineKeyboardButton(text="Инфокоммуникационные системы и их информационная защита",
                                    callback_data="lol11_250")
...
lol_iret3250 = InlineKeyboardButton(
    text="Интеллектуальная радиоэлектроника и фотоника, встроенные системы, интернет вещей", callback_data="lol[2]_250")
...
lol_iret5250 = InlineKeyboardButton(
    text="Системы передачи и обработки информации, управления, навигации и радиоэлектронной борьбы",
    callback_data="lol[4]_250")
