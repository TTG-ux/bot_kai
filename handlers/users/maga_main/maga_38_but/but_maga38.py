...
from keyboards.inline.maga_inline_main.inline_maga_38.in_maga_38 import menu_maga_inline_button_38, menu_maga_ineline_button_38_1,\
    back_maga_inline_button_38
from keyboards.inline.maga_inline_main.midle_maga_inline import menu_maga_button_38
...
# ИРЭФ-ЦТ
@dp.callback_query_handler(text="IREF_CT_maga_3")
async def IANT_2(c: CallbackQuery):
    ...
    await c.message.answer("Вы выбрали <b><ins>Институт Радиоэлектроники, фотоники и цифровых технологий</ins></b>\n\n"
                           "Направления:", reply_markup=menu_maga_inline_button_38)


# 30
@dp.callback_query_handler(text="Design_technology_maga_3")
async def iret_iktfiz_1(c: CallbackQuery):
    ...
    await c.message.answer(
        ...
        reply_markup=back_maga_inline_button_38)


# 38
@dp.callback_query_handler(text="Infocommunication_technologies_3")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# ИАЭП
@dp.callback_query_handler(text="IANT_maga_3")
async def IANT_2(c: CallbackQuery):
    await c.answer(cache_time=60)
    ...
    await c.message.answer("Вы выбрали <b><ins>Институт автоматики и электронного приборостроения</ins></b>\n\n"
                           "Направления:", reply_markup=menu_maga_ineline_button_38_1)


# 33
@dp.callback_query_handler(text="Equipment_Management_maga_3")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
    ...
    await c.message.answer(
        ...
        f"• технолог\n"
        f"• инженер-конструктор\n"
        f"• инженер-проектировщик", reply_markup=back_maga_inline_button_38)


# назад
@dp.callback_query_handler(text="back_maga_38")
async def b_177(c: CallbackQuery):
    ...
    await c.message.answer(f"Выбери факультет", reply_markup=menu_maga_button_38)


# исклик то назад к факультетам
@dp.callback_query_handler(text="back_maga_38_3")
async def b_177(c: CallbackQuery):
    await c.answer(cache_time=60)
