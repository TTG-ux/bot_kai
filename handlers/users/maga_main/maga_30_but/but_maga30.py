...
from keyboards.inline.maga_inline_main.inline_maga_30.in_maga_30 import menu_maga_button_inline_30
...
# ИРЭФ-ЦТ
@dp.callback_query_handler(text="IREF_CT_maga_1")
async def IANT_2(c: CallbackQuery):
    ...
    await c.message.answer("Вы выбрали <b><ins>Институт Радиоэлектроники, фотоники и цифровых технологий</ins></b>\n\n"
                           "Направления:", reply_markup=menu_maga_button_inline_30)


# 30
@dp.callback_query_handler(text="Design_technology_maga_1")
