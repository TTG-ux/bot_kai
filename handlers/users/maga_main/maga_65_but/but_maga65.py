...
from keyboards.inline.maga_inline_main.inline_maga_65.in_maga_65 import menu_maga_inline_button_65, \
    menu_maga_ineline_button_65_1, menu_maga_ineline_button_65_2, menu_maga_ineline_button_65_3, menu_maga_ineline_button_65_4,\
    back_maga_inline_button_65
from keyboards.inline.maga_inline_main.midle_maga_inline import menu_maga_button_65
...
# ИРЭФ-ЦТ
@dp.callback_query_handler(text="IREF_CT_maga_11")
async def IANT_2(c: CallbackQuery):
    ...
    await c.message.answer("Вы выбрали <b><ins>Институт Радиоэлектроники, фотоники и цифровых технологий</ins></b>\n\n"
                           "Направления:", reply_markup=menu_maga_inline_button_65)


# 30
@dp.callback_query_handler(text="Design_technology_maga_11")
async def iret_iktfiz_1(c: CallbackQuery):
    ...
    await c.message.answer(
        ...
        reply_markup=back_maga_inline_button_65)


# 38
@dp.callback_query_handler(text="Infocommunication_technologies_11")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 40
@dp.callback_query_handler(text="Radio_engineering_maga_11")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 56
@dp.callback_query_handler(text="Electronics_and_nanoelectronics_maga_11")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# ИАЭП
@dp.callback_query_handler(text="IANT_maga_11")
async def IANT_2(c: CallbackQuery):
    await c.answer(cache_time=60)
    ...
    await c.message.answer("Вы выбрали <b><ins>Институт автоматики и электронного приборостроения</ins></b>\n\n"
                           "Направления:", reply_markup=menu_maga_ineline_button_65_1)


# 33
@dp.callback_query_handler(text="Equipment_Management_maga_11")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
    ...
    await c.message.answer(
        ...
        f"• технолог\n"
        f"• инженер-конструктор\n"
        f"• инженер-проектировщик", reply_markup=back_maga_inline_button_65)


# ИКТЗИ
@dp.callback_query_handler(text="IKTZI_maga_11")
async def IANT_2(c: CallbackQuery):
    await c.answer(cache_time=60)
    ...
    await c.message.answer("Вы выбрали <b><ins>Институт компьтерных технологий и защиты информации</ins></b>\n\n"
                           "Направления:", reply_markup=menu_maga_ineline_button_65_2)


# 39
@dp.callback_query_handler(text="Applied_athematics_maga_11")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 44
@dp.callback_query_handler(text="Information_systems_and_technologies_11")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 54
@dp.callback_query_handler(text="Computer_science_and_engineering_11")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# ФМФ
@dp.callback_query_handler(text="FMF_maga_11")
async def IANT_2(c: CallbackQuery):
    await c.answer(cache_time=60)
    ...
    await c.message.answer("Вы выбрали <b><ins>Физико-математический факультет</ins></b>\n\n"
                           "Направления:", reply_markup=menu_maga_ineline_button_65_3)


# 48
@dp.callback_query_handler(text="Nanomaterials_maga_11")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# ИАНТЭ
@dp.callback_query_handler(text="IANTE_maga_11")
async def IANT_2(c: CallbackQuery):
    await c.answer(cache_time=60)
    ...
    await c.message.delete()
    await c.message.answer("Вы выбрали <b><ins>Институт Радиоэлектроники, фотоники и цифровых технологий</ins></b>\n\n"
                           "Направления:", reply_markup=menu_maga_ineline_button_65_4)


# 63
@dp.callback_query_handler(text="Heat_power_engineering_and_heat_engineering_maga_11")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 65
@dp.callback_query_handler(text="Design_and_technological_support_maga_11")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# назад
@dp.callback_query_handler(text="back_maga_65")
async def b_177(c: CallbackQuery):
    ...
    await c.message.answer(f"Выбери факультет", reply_markup=menu_maga_button_65)


# исклик то назад к факультетам
@dp.callback_query_handler(text="back_maga_65_11")
async def b_177(c: CallbackQuery):
    await c.answer(cache_time=60)
