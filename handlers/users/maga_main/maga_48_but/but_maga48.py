...
from keyboards.inline.maga_inline_main.inline_maga_48.in_maga_48 import menu_maga_inline_button_48, \
    menu_maga_ineline_button_48_1, menu_maga_ineline_button_48_2, menu_maga_ineline_button_48_3, back_maga_inline_button_48
from keyboards.inline.maga_inline_main.midle_maga_inline import menu_maga_button_48
...
# ИРЭФ-ЦТ
@dp.callback_query_handler(text="IREF_CT_maga_7")
async def IANT_2(c: CallbackQuery):
    ...
    await c.message.answer("Вы выбрали <b><ins>Институт Радиоэлектроники, фотоники и цифровых технологий</ins></b>\n\n"
                           "Направления:", reply_markup=menu_maga_inline_button_48)


# 30
@dp.callback_query_handler(text="Design_technology_maga_7")
async def iret_iktfiz_1(c: CallbackQuery):
    ...
    await c.message.answer(
        ...
        reply_markup=back_maga_inline_button_48)


# 38
@dp.callback_query_handler(text="Infocommunication_technologies_7")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 40
@dp.callback_query_handler(text="Radio_engineering_maga_7")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# ИАЭП
@dp.callback_query_handler(text="IANT_maga_7")
async def IANT_2(c: CallbackQuery):
    await c.answer(cache_time=60)
    ...
    await c.message.answer("Вы выбрали <b><ins>Институт автоматики и электронного приборостроения</ins></b>\n\n"
                           "Направления:", reply_markup=menu_maga_ineline_button_48_1)


# 33
@dp.callback_query_handler(text="Equipment_Management_maga_7")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
    ...
    await c.message.answer(
        ...
        f"• технолог\n"
        f"• инженер-конструктор\n"
        f"• инженер-проектировщик", reply_markup=back_maga_inline_button_48)


# ИКТЗИ
@dp.callback_query_handler(text="IKTZI_maga_7")
async def IANT_2(c: CallbackQuery):
    await c.answer(cache_time=60)
    ...
    await c.message.answer("Вы выбрали <b><ins>Институт компьтерных технологий и защиты информации</ins></b>\n\n"
                           "Направления:", reply_markup=menu_maga_ineline_button_48_2)


# 39
@dp.callback_query_handler(text="Applied_athematics_maga_7")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 44
@dp.callback_query_handler(text="Information_systems_and_technologies_7")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# ФМФ
@dp.callback_query_handler(text="FMF_maga_7")
async def IANT_2(c: CallbackQuery):
    await c.answer(cache_time=60)
    ...
    await c.message.answer("Вы выбрали <b><ins>Физико-математический факультет</ins></b>\n\n"
                           "Направления:", reply_markup=menu_maga_ineline_button_48_3)


# 48
@dp.callback_query_handler(text="Nanomaterials_maga_7")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# назад
@dp.callback_query_handler(text="back_maga_48")
async def b_177(c: CallbackQuery):
    ...
    await c.message.answer(f"Выбери факультет", reply_markup=menu_maga_button_48)


# исклик то назад к факультетам
@dp.callback_query_handler(text="back_maga_48_7")
async def b_177(c: CallbackQuery):
    await c.answer(cache_time=60)
