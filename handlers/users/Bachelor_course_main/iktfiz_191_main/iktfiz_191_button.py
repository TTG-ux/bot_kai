...
from keyboards.inline.Bachelor_course_inline.iktfiz_191_inline.iktfiz_191_inbut import menu_191iktfiz_button, menu_191iktfiz_button_1, \
    menu_191iktfiz_button_2, back_191_button
from keyboards.inline.ikt_fiz_inline.ikt_fiziks_b import menu_iltfiz_button_191
...
# Ирэт
@dp.callback_query_handler(text="IREF-CT_7")
async def IANT_2(c: CallbackQuery):
    ...
    await c.message.answer("Вы выбрали <b><ins>Институт Радиоэлектроники, фотоники и цифровых технологий</ins></b>\n\n"
                           "Направления:", reply_markup=menu_191iktfiz_button)


# 169
@dp.callback_query_handler(text="Transmission_systems_iktfiz_6")
async def iret_iktfiz_1(c: CallbackQuery):
    ...
    await c.message.answer(f"Преподаватели:\n"
                           ...
                           reply_markup=back_191_button)


# 188(1)
@dp.callback_query_handler(text="Design_technology_6")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 188(2)
@dp.callback_query_handler(text="information_protection_6")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 191
@dp.callback_query_handler(text="Intelligent_radio_electronics_6")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# ИАЭП
@dp.callback_query_handler(text="IAP_7")
async def iaap_2(c: CallbackQuery):
    ...
    await c.message.answer(f"Вы выбрали <b><ins>Институт автоматики и электронного приборостроения</ins></b>\n"
                           f"Направления:", reply_markup=menu_191iktfiz_button_1)


# 177
@dp.callback_query_handler(text="Optoelectronic_systems_6")
...
# 181
@dp.callback_query_handler(text="Information_systems_6")
async def iaap_2(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 189(1)
@dp.callback_query_handler(text="Standardization_6")
async def iaap_2(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 189(2)
@dp.callback_query_handler(text="Quality_management_6")
async def iaap_2(c: CallbackQuery):
    await c.answer(cache_time=60)
...
@dp.callback_query_handler(text="IANT_7")
async def iaap_2(c: CallbackQuery):
    await c.answer(cache_time=60)
    ...
    await c.message.answer(f"Вы выбрали <b><ins>Институт авиации, наземного транспорта и энергетики</ins></b>\n"
                           f"Направления:", reply_markup=menu_191iktfiz_button_2)


# 181
@dp.callback_query_handler(text="Aerospace_Science_6")
...
# назад
@dp.callback_query_handler(text="back_191")
async def b_177(c: CallbackQuery):
    ...
    await c.message.answer(f"Выбери факультет", reply_markup=menu_iltfiz_button_191)


# исклик то назад к факультетам
@dp.callback_query_handler(text="back_191_1")
async def b_177(c: CallbackQuery):
    await c.answer(cache_time=60)
