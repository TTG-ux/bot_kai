...
from keyboards.inline.Bachelor_course_inline.iktfiz_206_inline.iktfiz_206_inbut import menu_206iktfiz_button, menu_206iktfiz_button_1, \
    menu_206iktfiz_button_2, back_206_button
from keyboards.inline.ikt_fiz_inline.ikt_fiziks_b import menu_iltfiz_button_206
...
# Ирэт
@dp.callback_query_handler(text="IREF-CT_13")
async def IANT_2(c: CallbackQuery):
    ...
    await c.message.answer("Вы выбрали <b><ins>Институт Радиоэлектроники, фотоники и цифровых технологий</ins></b>\n\n"
                           "Направления:", reply_markup=menu_206iktfiz_button)


# 169
@dp.callback_query_handler(text="Transmission_systems_iktfiz_12")
async def iret_iktfiz_1(c: CallbackQuery):
    ...
    await c.message.answer(f"Преподаватели:\n"
                           ...
                           reply_markup=back_206_button)


# 188(1)
@dp.callback_query_handler(text="Design_technology_12")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 188(2)
@dp.callback_query_handler(text="information_protection_12")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 191
@dp.callback_query_handler(text="Intelligent_radio_electronics_12")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# ИАЭП
@dp.callback_query_handler(text="IAP_13")
async def iaap_2(c: CallbackQuery):
    ...
    await c.message.answer(f"Вы выбрали <b><ins>Институт автоматики и электронного приборостроения</ins></b>\n"
                           f"Направления:", reply_markup=menu_206iktfiz_button_1)


# 177
@dp.callback_query_handler(text="Optoelectronic_systems_12")
...
# 181
@dp.callback_query_handler(text="Information_systems_12")
async def iaap_2(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 189(1)
@dp.callback_query_handler(text="Standardization_12")
async def iaap_2(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 189(2)
@dp.callback_query_handler(text="Quality_management_12")
async def iaap_2(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 193
@dp.callback_query_handler(text="Electrical_of_enterprises_12")
async def iaap_2(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 206
@dp.callback_query_handler(text="Environmental_engineering_12")
async def iaap_2(c: CallbackQuery):
    await c.answer(cache_time=60)
...
@dp.callback_query_handler(text="IANT_13")
async def iaap_2(c: CallbackQuery):
    await c.answer(cache_time=60)
    ...
    await c.message.answer(f"Вы выбрали <b><ins>Институт авиации, наземного транспорта и энергетики</ins></b>\n"
                           f"Направления:", reply_markup=menu_206iktfiz_button_2)


# 181
@dp.callback_query_handler(text="Aerospace_Science_12")
...
# 194(1)
@dp.callback_query_handler(text="Modern_ welding_materials_12")
async def iant_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 194(2)
@dp.callback_query_handler(text="Mechanical_engineering_technology_12")
async def iant_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 196
@dp.callback_query_handler(text="Gas_turbine_installations_12")
async def iant_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 199(1)
@dp.callback_query_handler(text="Resource_efficient_technologies_12")
async def iant_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 199(2)
@dp.callback_query_handler(text="Shipbuilding_12")
async def iant_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 203
@dp.callback_query_handler(text="Rocket_engines_12")
async def iant_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 206
@dp.callback_query_handler(text="Road_transport_12")
async def iant_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# назад
@dp.callback_query_handler(text="back_206")
async def b_177(c: CallbackQuery):
    ...
    await c.message.answer(f"Выбери факультет", reply_markup=menu_iltfiz_button_206)


# исклик то назад к факультетам
@dp.callback_query_handler(text="back_206_1")
async def b_177(c: CallbackQuery):
    await c.answer(cache_time=60)
