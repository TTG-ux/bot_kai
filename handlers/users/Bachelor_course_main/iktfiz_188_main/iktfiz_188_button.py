...
from keyboards.inline.Bachelor_course_inline.iktfiz_188_inline.iktfiz_188_inbut import menu_188iktfiz_button, menu_188iktfiz_button_1, \
    menu_188iktfiz_button_2, back_188_button
from keyboards.inline.ikt_fiz_inline.ikt_fiziks_b import menu_iltfiz_button_188
...
# Ирэт
@dp.callback_query_handler(text="IREF-CT_5")
async def IANT_2(c: CallbackQuery):
    ...
    await c.message.answer("Вы выбрали <b><ins>Институт Радиоэлектроники, фотоники и цифровых технологий</ins></b>\n\n"
                           "Направления:", reply_markup=menu_188iktfiz_button)


# 169
@dp.callback_query_handler(text="Transmission_systems_iktfiz_4")
async def iret_iktfiz_1(c: CallbackQuery):
    ...
    await c.message.answer(f"Преподаватели:\n"
                           ...
                           reply_markup=back_188_button)


# 188(1)
@dp.callback_query_handler(text="Design_technology_4")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 188(2)
@dp.callback_query_handler(text="information_protection_4")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# ИАЭП
@dp.callback_query_handler(text="IAP_5")
async def iaap_2(c: CallbackQuery):
    ...
    await c.message.answer(f"Вы выбрали <b><ins>Институт автоматики и электронного приборостроения</ins></b>\n"
                           f"Направления:", reply_markup=menu_188iktfiz_button_1)


# 177
@dp.callback_query_handler(text="Optoelectronic_systems_4")
...
# 181
@dp.callback_query_handler(text="Information_systems_4")
async def iaap_2(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# ИАНТЭ
@dp.callback_query_handler(text="IANT_5")
async def iaap_2(c: CallbackQuery):
    await c.answer(cache_time=60)
    ...
    await c.message.answer(f"Вы выбрали <b><ins>Институт авиации, наземного транспорта и энергетики</ins></b>\n"
                           f"Направления:", reply_markup=menu_188iktfiz_button_2)


# 181
@dp.callback_query_handler(text="Aerospace_Science_4")
...
# назад
@dp.callback_query_handler(text="back_188")
async def b_177(c: CallbackQuery):
    ...
    await c.message.answer(f"Выбери факультет", reply_markup=menu_iltfiz_button_188)


# исклик то назад к факультетам
@dp.callback_query_handler(text="back_188_1")
async def b_177(c: CallbackQuery):
    await c.answer(cache_time=60)
