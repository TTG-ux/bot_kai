...
from keyboards.inline.Bachelor_course_inline.iktfiz_193_inline.iktfiz_193_inbut import menu_193iktfiz_button, menu_193iktfiz_button_1, \
    menu_193iktfiz_button_2, back_193_button
from keyboards.inline.ikt_fiz_inline.ikt_fiziks_b import menu_iltfiz_button_193
...
# Ирэт
@dp.callback_query_handler(text="IREF-CT_8")
async def IANT_2(c: CallbackQuery):
    ...
    await c.message.answer("Вы выбрали <b><ins>Институт Радиоэлектроники, фотоники и цифровых технологий</ins></b>\n\n"
                           "Направления:", reply_markup=menu_193iktfiz_button)


# 169
@dp.callback_query_handler(text="Transmission_systems_iktfiz_7")
async def iret_iktfiz_1(c: CallbackQuery):
    ...
    await c.message.answer(f"Преподаватели:\n"
                           ...
                           reply_markup=back_193_button)


# 188(1)
@dp.callback_query_handler(text="Design_technology_7")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 188(2)
@dp.callback_query_handler(text="information_protection_7")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 191
@dp.callback_query_handler(text="Intelligent_radio_electronics_7")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# ИАЭП
@dp.callback_query_handler(text="IAP_8")
async def iaap_2(c: CallbackQuery):
    ...
    await c.message.answer(f"Вы выбрали <b><ins>Институт автоматики и электронного приборостроения</ins></b>\n"
                           f"Направления:", reply_markup=menu_193iktfiz_button_1)


# 177
@dp.callback_query_handler(text="Optoelectronic_systems_7")
...
# 181
@dp.callback_query_handler(text="Information_systems_7")
async def iaap_2(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 189(1)
@dp.callback_query_handler(text="Standardization_7")
async def iaap_2(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 189(2)
@dp.callback_query_handler(text="Quality_management_7")
async def iaap_2(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 193
@dp.callback_query_handler(text="Electrical_of_enterprises_7")
async def iaap_2(c: CallbackQuery):
    await c.answer(cache_time=60)
...
@dp.callback_query_handler(text="IANT_8")
async def iaap_2(c: CallbackQuery):
    await c.answer(cache_time=60)
    ...
    await c.message.answer(f"Вы выбрали <b><ins>Институт авиации, наземного транспорта и энергетики</ins></b>\n"
                           f"Направления:", reply_markup=menu_193iktfiz_button_2)

# 181
@dp.callback_query_handler(text="Aerospace_Science_7")
...
# назад
@dp.callback_query_handler(text="back_193")
async def b_177(c: CallbackQuery):
    ...
    await c.message.answer(f"Выбери факультет", reply_markup=menu_iltfiz_button_193)


# исклик то назад к факультетам
@dp.callback_query_handler(text="back_193_1")
async def b_177(c: CallbackQuery):
    await c.answer(cache_time=60)
