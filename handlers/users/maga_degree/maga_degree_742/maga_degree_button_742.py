...
from keyboards.inline.maga_degree_inline.maga_degree_inbut_742.maga_degree_inl_742 import menu_maga_degreet_742, back_maga_degree_742
from keyboards.inline.maga_degree_inline.maga_degee_main_inbut import menu_maga_degree_742
...
# ИАЭП
@dp.callback_query_handler(text="IANT_maga_degree_3")
async def IANT_2(c: CallbackQuery):
    ...
    await c.message.answer("Вы выбрали <b><ins>Институт авиации, наземного транспорта и энергетики</ins></b>\n"
                           "Направления:", reply_markup=menu_maga_degreet_742)


# 62,1
@dp.callback_query_handler(text="Materials_science_and_technology_of_materials_maga_degree_3")
async def iret_iktfiz_1(c: CallbackQuery):
    ...
    await c.message.answer(
        ...
        reply_markup=back_maga_degree_742)


# 74,15
@dp.callback_query_handler(text="Design_and_technological_support_maga_degree_3")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# 74,6
@dp.callback_query_handler(text="Aircraft_construction_maga_degeree_3")
async def iret_iktfiz_1(c: CallbackQuery):
    await c.answer(cache_time=60)
...
# назад
@dp.callback_query_handler(text="back_maga_degree_742")
async def b_177(c: CallbackQuery):
    ...
    await c.message.answer(f"Выбери факультет", reply_markup=menu_maga_degree_742)


# исклик то назад к факультетам
@dp.callback_query_handler(text="back_maga_degree_742_3")
async def b_177(c: CallbackQuery):
    await c.answer(cache_time=60)
